...
<a href="create.php?username=<?php echo $username; ?>">Submit new application</a>
    ...
    <tbody>
        ...
        while ($row = mysqli_fetch_assoc($forms)) { ?>
            <tr>
                ...
                <td>
                    <a href="/mnu/exam_script_viewing_forms/edit.php?id=<?php echo $row['id']; ?>&username=<?php echo $username; ?>">Edit</a>
                    <span> | <span>
                    <a href="/mnu/exam_script_viewing_forms/delete.php?id=<?php echo $row['id']; ?>&username=<?php echo $username; ?>">Delete</a>
                </td>
            </tr>
        <?php } ?>
